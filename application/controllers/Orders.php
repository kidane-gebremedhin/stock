...
class Orders extends Admin_Controller 
{
	public function __construct()
	{
        ...
        $this->load->model('model_issued_products');
	...
	public function fetchOrdersData()
	{
		...
		foreach ($data as $key => $value) {
			...
			$result['data'][$key] = array(
				'<a href="'.base_url('orders/detail/'.$value['id']).'">'.$value['bill_no'].'</a>',
				$value['customer_name'],
	...
	public function create()
	{
        ...
        if ($this->form_validation->run() == TRUE) {        	
        	...
        	if($order_id) {
        		...
        		$custom_attributes = $this->model_custom_attributes->getAttributeData();      
        		foreach ($custom_attributes as $k => $v) {
			        $custom_data = array(
		        		'order_id' => $order_id,
		        		'custom_attribute_id' => $v['id'],
		        		'value' => $this->input->post($v['id'].'_value'),
			        	);
        			$this->model_custom_attributes->createOrderCustomAttributeValue($custom_data);
        			}	
        	...
        	$stores_data = $this->model_stores->getStoresData();
      	    $this->data['stores_data'] = $stores_data;
	...
	*/
	public function update($id)
	{
        ...
        if ($this->form_validation->run() == TRUE) {        	
        	...
        	if($update == true) {
        		...
        		$custom_attributes = $this->model_custom_attributes->getAttributeData();      
        		foreach ($custom_attributes as $k => $v) {
		        	$value_id = $this->input->post($v['id'].'_value_id');
			        $custom_data = array(
		        		'order_id' => $id,
		        		'custom_attribute_id' => $v['id'],
		        		'value' => $this->input->post($v['id'].'_value'),
			        	);
        			$this->model_custom_attributes->updateOrderCustomAttributeValue($custom_data, $value_id);
        			}
        	...
        	$this->data['products'] = $this->model_products->getActiveProductData();      	
        	$this->data['custom_attributes'] = $this->model_custom_attributes->getAttributeData();
           	$this->data['order_custom_attribute_values'] = $this->model_custom_attributes->getOrderCustomAttributeValuesData($id);  
	...
	public function detail($id)
	{
		...
		$this->data['page_title'] = 'Order Detail';
            ...
            $this->render_template('orders/detail', $this->data);
	}
	...
	public function printDiv($id)
	{
		...
		if($id) {
			...
			<head>
			  ...
			  <title> '.$company_info['company_name'].' | Invoice</title>
