...
class Products extends Admin_Controller 
{
    ...
    */
	public function fetchProductData()
	{
		...
		foreach ($data as $key => $value) {
			...
			$img = '<a href="'.base_url($value['image']).'" target="_blank"><img src="'.base_url($value['image']).'" alt="'.$value['name'].'" class="img-circle" width="50" height="50" /></a>';
           ...
           $remained_days=0;
            ...
            $remained_days = '<span class="label <?php echo '.($remained_days>$value['beforeExpDays']? 'label-primary': 'label-warning').' ?>">'.$remained_days.' days</label>';
            */
			...
			$result['data'][$key] = array(
				$img,
				$value['sku'],
				'<a href="'.base_url('products/detail/'.$value['id']).'">'.$value['name'].'</a>',
    ...
    */
	public function create()
	{
        ...
        $this->form_validation->set_rules('minQty', 'Min Qty', 'trim|required');
        $this->form_validation->set_rules('beforeExpDays', 'Before Exp Days', 'trim');
        ...
        //        'qty' => $this->input->post('qty'),
                ...
                'beforeExpDays' => $this->input->post('beforeExpDays'),
        		'image' => $upload_image,
        	...
        	$create2 = $this->model_received_products->create($data2);*/
    ...
    */
	public function upload_image()
    {
        ...
        if ( ! $this->upload->do_upload('product_image'))
        {
            ...
            return 'assets/images/product-img.jpg';//$error;
        }
        else
        {
    ...
    */
	...
	{      
        ...
        //$this->form_validation->set_rules('qty', 'Qty', 'trim|required');
        $this->form_validation->set_rules('minQty', 'Min Qty', 'trim|required');
        $this->form_validation->set_rules('expDate', 'Expiry Qty', 'trim');
        $this->form_validation->set_rules('beforeExpDays', 'Before Exp Days', 'trim');
        //$this->form_validation->set_rules('store', 'Store', 'trim|required');
        $this->form_validation->set_rules('availability', 'Availability', 'trim|required');
