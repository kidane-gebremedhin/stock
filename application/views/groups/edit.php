                ...
                <div class="form-group">
                  ...
                  <table class="table table-responsive table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Receivables</td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="createReceivable" <?php if($serialize_permission) {
                          if(in_array('createReceivable', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="updateReceivable" <?php if($serialize_permission) {
                          if(in_array('updateReceivable', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="viewReceivable" <?php if($serialize_permission) {
                          if(in_array('viewReceivable', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="deleteReceivable" <?php if($serialize_permission) {
                          if(in_array('deleteReceivable', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                      </tr>
                      <tr>
                        <td>Transactions</td>
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="viewTransactions" <?php if($serialize_permission) {
                          if(in_array('viewTransactions', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td> - </td>
                      </tr>
                      <tr>
