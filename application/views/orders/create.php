          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              ...
              <div class="col-md-6 col-md-offset-1 col-xs-12 pull pull-left">
                  ...
                  <tbody>
                    <?php foreach ($custom_attributes as $k => $v): ?>
                      ...
                      <td><strong><?php echo $v['name']; ?></strong></td>
                        <td>
                          <input type="text" class="<?php echo $v['is_number']==1? 'number': ''; ?> form-control" id="<?php echo $v['id'].'_value'; ?>" name="<?php echo $v['id'].'_value'; ?>" placeholder="Enter value" autocomplete="off" />
                        </td>
                      </tr>
                    <?php endforeach ?>
                  </tbody>
                ...
                <table class="table table-bordered" id="product_info_table">
                  <thead>
                    <tr>
                      <th style="width:30%"><?php echo $_SESSION['Item'] ?></th>
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-success pull-right"><i class="fa fa-usd"></i> <strong>Place Order</strong></button>
