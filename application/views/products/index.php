    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createProduct', $user_permission)): ?>
          <a href="<?php echo base_url('products/create') ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add <?php echo $_SESSION['Item'] ?></a>
          <br /> <br />
        <?php endif; ?>

        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Manage <?php echo $_SESSION['Items'] ?></h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            ...
            <table id="manageTable" class="table table-bordered table-striped">
              ...
              <tr>
                <th>Image</th>
                <th>Identifier</th>
                <th><?php echo $_SESSION['Item'] ?> Name</th>
                <th>Qty</th>
                <th>Min Qty</th>
<!--                 <th>Expity Date</th>
                <th>Days Left</th>
