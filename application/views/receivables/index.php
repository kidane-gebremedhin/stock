    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createProduct', $user_permission)): ?>
          <a href="<?php echo base_url('receivables/create') ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add Receivable</a>
          <br /> <br />
        <?php endif; ?>

        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Manage Receivables</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
...
$(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'receivables/fetchReceivableData',
    'order': []
  });
