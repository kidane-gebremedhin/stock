        ...
        <?php if($user_permission): ?>
          ...
          <?php if(in_array('createUnit', $user_permission) || in_array('updateUnit', $user_permission) || in_array('viewUnit', $user_permission) || in_array('deleteUnit', $user_permission)): ?>
            <li id="unitNav">
              <a href="<?php echo base_url('units/') ?>">
                <i class="glyphicon glyphicon-tags"></i> <span>Measurment Units</span>
              </a>
            </li>
          <?php endif; ?>
          ...
          <?php if(in_array('createStore', $user_permission) || in_array('updateStore', $user_permission) || in_array('viewStore', $user_permission) || in_array('deleteStore', $user_permission)): ?>
            <li id="storeNav">
              <a href="<?php echo base_url('stores/') ?>">
                <i class="fa fa-files-o"></i> <span>Branchs/Stores</span>
              </a>
            </li>
          <?php endif; ?>
          ...
          <li id="attributeNav">
            <a href="<?php echo base_url('attributes/') ?>">
              <i class="fa fa-files-o"></i> <span><?php echo $_SESSION['Item'] ?> Attributes</span>
            </a>
          </li>
          <?php endif; ?>
          ...
          <?php if(in_array('createAttribute', $user_permission) || in_array('updateAttribute', $user_permission) || in_array('viewAttribute', $user_permission) || in_array('deleteAttribute', $user_permission)): ?>
          <li id="attributeNav">
            <a href="<?php echo base_url('custom_attributes/') ?>">
              <i class="fa fa-files-o"></i> <span>Order Custom Attributes</span>
            </a>
          </li>
          <?php endif; ?>
          ...
          <?php if(in_array('createProduct', $user_permission) || in_array('updateProduct', $user_permission) || in_array('viewProduct', $user_permission) || in_array('deleteProduct', $user_permission)): ?>
            <li class="treeview" id="mainProductNav">
              <a href="#">
                ...
                <span><?php echo $_SESSION['Items'] ?></span>
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <?php if(in_array('createProduct', $user_permission)): ?>
                  <li id="addProductNav"><a href="<?php echo base_url('products/create') ?>"><i class="fa fa-circle-o"></i> Add <?php echo $_SESSION['Item'] ?></a></li>
                <?php endif; ?>
                <?php if(in_array('updateProduct', $user_permission) || in_array('viewProduct', $user_permission) || in_array('deleteProduct', $user_permission)): ?>
                <li id="manageProductNav"><a href="<?php echo base_url('products') ?>"><i class="fa fa-circle-o"></i> Manage <?php echo $_SESSION['Items'] ?></a></li>
                <?php endif; ?>
              </ul>
            </li>
          <?php endif; ?>
          <?php if(in_array('createReceivable', $user_permission) || in_array('updateReceivable', $user_permission) || in_array('viewReceivable', $user_permission) || in_array('deleteReceivable', $user_permission)): ?>
            <li id="receivableNav">
              <a href="<?php echo base_url('receivables/') ?>">
                <i class="glyphicon glyphicon-tags"></i> <span>Receivables</span>
              </a>
            </li>
          <?php endif; ?>
          ...
          <?php if(in_array('viewTransactions', $user_permission)): ?>
            <li id="receivableNav">
              <a href="<?php echo base_url('receivables/transactionsData') ?>">
                <i class="glyphicon glyphicon-tags"></i> <span>Transactions</span>
              </a>
            </li>
          <?php endif; ?>
