    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createUnit', $user_permission)): ?>
          <button class="btn btn-primary" data-toggle="modal" data-target="#addUnitModal"><i class="fa fa-plus"></i> Add Unit</button>
          <br /> <br />
        <?php endif; ?>
...
<div class="modal fade" tabindex="-1" role="dialog" id="addUnitModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('units/create') ?>" method="post" id="createUnitForm">
...
<div class="modal fade" tabindex="-1" role="dialog" id="editUnitModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('units/update') ?>" method="post" id="updateUnitForm">
...
<!-- remove Unit modal -->
<div class="modal fade" tabindex="-1" role="dialog" id="removeUnitModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <form role="form" action="<?php echo base_url('units/remove') ?>" method="post" id="removeUnitForm">
        <div class="modal-body">
...
{ 
  $.ajax({
    url: 'fetchUnitDataById/'+id,
    type: 'post',
    dataType: 'json',
    success:function(response) {
      $("#edit_unit_name").val(response.name);
        ...
        $.ajax({
          ...
          success:function(response) {
            ...
            if(response.success === true) {
              ...
              // reset the form 
              $("#updateUnitForm .form-group").removeClass('has-error').removeClass('has-success');
...
{
  if(id) {
    $("#removeUnitForm").on('submit', function() {
